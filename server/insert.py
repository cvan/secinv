...
system_dict = {'kernel_rel': '2.9.18-194.3.1.el5', 'hostname': 'cm-sectest02', 'nfs': 1, 'rh_rel': '5.8 (Orange)'}
        ...
        try:
            ...
            if s_diff:
                s_dict = {'machine': self.machine_obj,
                          ...
                          'ports': csv_ports,
                          'diff': ','.join(s_diff),
                          'diff_ins_processes': ','.join(s_diff_ins_processes),
                          'diff_del_processes': ','.join(s_diff_del_processes),
                          'diff_ins_ports': ','.join(s_diff_ins_ports),
                          'diff_del_ports': ','.join(s_diff_del_ports)}
